    ...
    >
        ...
        <div class="fi-ta-main">
                ...
                >
                    ...
                    @if ($isGlobalSearchVisible || $hasFiltersTrigger || $hasColumnManager)
                        <div class="fi-ta-search-container flex flex-wrap items-center justify-between gap-2 w-full sm:w-auto sm:justify-end">
                            ...
                            @if ($hasPagination && count($paginationPageOptions) > 1)
                                <div class="fi-ta-top-records-per-page">
                                    <x-filament::input.wrapper>
                                        <x-filament::input.select
                                            wire:model.live="tableRecordsPerPage"
                                        >
                                            @foreach ($paginationPageOptions as $option)
                                                <option value="{{ $option }}">
            ...
            @if ($hasPagination)
                ...
                <div class="fi-ta-pagination-ctn flex justify-center py-3 border-t border-gray-200 dark:border-white/10">
