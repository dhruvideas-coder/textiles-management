...
class ChallanPolicy
{
    ...
    public function view(User $user, Challan $challan): bool
    {
        ...
        if ($user->role === 'owner') return $challan->owner_id === $user->id;
        if ($user->role === 'staff') return $challan->owner_id === $user->owner_id;
        return false;
    }
    ...
    {
        if ($user->role === 'admin') return true;
        return $user->role === 'owner' && $challan->owner_id === $user->id;
    }
